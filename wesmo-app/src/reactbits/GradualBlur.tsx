...
const debounce = <T extends (...args: any[]) => void>(fn: T, wait: number): ((...a: Parameters<T>) => void) => {
...
function GradualBlur(props: GradualBlurProps) {
  ...
  const config = useMemo(() => {
    const presetConfig =
      props.preset && PRESETS[props.preset as PresetKey]
        ? PRESETS[props.preset as PresetKey]
        : {};
  ...
  const blurDivs = useMemo(() => {
    ...
    const curveKey = config.curve as keyof typeof CURVE_FUNCTIONS;
